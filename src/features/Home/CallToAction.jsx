...
const CallToAction = () => {
  return (
    <section className="text-white h-auto lg:h-[600px] py-12">
      <div className="container flex flex-col-reverse lg:flex-row px-6 lg:px-24 justify-center items-center gap-12">
        ...
        {/* Right Image */}
        <div className="w-full lg:w-1/2 flex justify-center lg:justify-end h-auto max-h-full overflow-hidden">
          <img
            src="/vectors/cta.svg"
            alt="Call to action"
